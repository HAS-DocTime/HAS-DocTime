...
export class PastAppointmentService {
  ...
  createPastAppointment(PastAppointment : PastAppointment): Observable<PastAppointment> {
    return this.http.post<PastAppointment>(`${this.base_url}postAppointmentData`, PastAppointment);
  }

  updatePastAppointment(PastAppointment : PastAppointment, id: number): Observable<PastAppointment> {
    console.log(id)
    console.log(PastAppointment)
    return this.http.put<PastAppointment>(`${this.base_url}postAppointmentData/${id}`, PastAppointment);
  }
}
