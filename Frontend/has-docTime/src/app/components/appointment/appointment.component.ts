...
import { PastAppointmentService } from 'src/app/services/medicalHistory.service';
...
export class AppointmentComponent implements OnInit{
  ...
  constructor(private appointmentService : AppointmentService, private userService : UserService, private router : Router, private route : ActivatedRoute, private departmentService : DepartmentService, private medicalHistoryService : PastAppointmentService){}
  ...
  appointmentDetails(appointment : Appointment){
    ...
    if(currentTime > startTime) {
      ...
      const medicalHistory : PastAppointment = {
      ...
      this.medicalHistoryService.createPastAppointment(medicalHistory).subscribe(
        (data:any) => {
